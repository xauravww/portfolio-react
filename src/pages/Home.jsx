...
const Home = ({ containerId }) => {
  ...
  return (
    ...
    >
      ...
      <h1 className="title item px-2 text-5xl text-center text-slate-300 font-extrabold z-10 md:text-7xl  lg:text-7xl w-5/6 md:w-4/6 lg:w-3/6">
        HEY, I'M SAURAV MAHESHWARI
      </h1>
      <p className="title-desc item text-center text-slate-300  px-10 text-4xl  md:text-6xl lg:text-6xl lg:px-40 z-[5] w-5/6">
