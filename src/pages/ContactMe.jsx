        ...
        >
            ...
            <div className="contact-sidebar sidebar-wrapper z-50 lg:hidden mt-8 opacity-0">
                <div className="sidebar flex justify-center items-center gap-4 border-2 border-[var(--border-color)] p-3 bg-[#33373E]/50 backdrop-blur-sm rounded-md">
                    <a href={import.meta.env.VITE_X_URL} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                        <img className={sidebarImgCSS} src={X} alt="X" />
                    </a>
                    <a href={import.meta.env.VITE_LINKEDIN_URL} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                        <img className={sidebarImgCSS} src={Linkedin} alt="LinkedIn" />
                    </a>
                    <a href={import.meta.env.VITE_SHOWWCASE_URL} target="_blank" rel="noopener noreferrer" aria-label="Showwcase">
            ...
            <div className="contact-sidebar hidden sidebar-wrapper fixed top-[40vh] left-8 z-50 flex-col justify-center items-center lg:flex lg:w-[4vw] opacity-0">
                <div className="sidebar flex flex-col justify-center items-center gap-4 border-2 border-[var(--border-color)] p-3 bg-[#33373E]/50 backdrop-blur-sm rounded-md shadow-lg">
                    <a href={import.meta.env.VITE_X_URL} target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hover:scale-110 transition-transform duration-300">
                        <img className={sidebarImgCSS} src={X} alt="X" />
                    </a>
                    <a href={import.meta.env.VITE_LINKEDIN_URL} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:scale-110 transition-transform duration-300">
                        <img className={sidebarImgCSS} src={Linkedin} alt="LinkedIn" />
                    </a>
                    <a href={import.meta.env.VITE_SHOWWCASE_URL} target="_blank" rel="noopener noreferrer" aria-label="Showwcase" className="hover:scale-110 transition-transform duration-300">
                        <img className={sidebarImgCSS} src={Showwcase} alt="Showwcase" />
                    </a>
                </div>
            </div>
