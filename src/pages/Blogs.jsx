...
const Blogs = ({ containerId }) => {
  ...
  return (
    <div
      className="Blogs h-screen relative bg-gradient-to-r from-[#2a1836] to-[#150c1b] flex flex-col justify-around items-center py-16 md:py-24"
      id={containerId}
    >
      ...
      <div className="blog-content rounded-xl max-w-[90vw] border-double border-4 border-[var(--border-color)] bg-[var(--bg-dark)] p-4 h-1/2 sm:w-80 md:w-96 flex flex-col items-center justify-center text-2xl text-[var(--text-light)] text-center z-[3] font-oregano opacity-0">
