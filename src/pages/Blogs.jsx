...
const Blogs = ({ containerId }) => {
  return (
    ...
    <div className="mask absolute top-0 left-0 h-full w-full bg-[rgba(0,0,0,0.6)] z-[2]"></div>
      <div className="blog-content bg-[#000] border-[#46285a] shadow-[0px_0px_50px_-30px_rgba(255,255,255,.6)] p-4 h-1/2 sm:w-80 md:w-96 flex flex-col items-center justify-center text-2xl text-white text-center z-[3] font-oregano">
